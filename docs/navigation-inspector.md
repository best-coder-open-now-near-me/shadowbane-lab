...
- [ ] Active: build the final committed source and record package validation/receipts.
- [ ] Coordinate the single bounded [developer/owner live pass](handoffs/navigation-inspector.md).
