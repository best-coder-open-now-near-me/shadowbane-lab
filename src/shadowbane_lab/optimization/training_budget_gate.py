...
class TrainingCatalogLegalityAudit(CatalogLegalityAudit):
    ...
    def as_dict(self) -> dict[str, object]:
        # slots=True replaces the dataclass, so zero-argument super() retains
        # the wrong class cell on supported Python versions.
        payload = super(TrainingCatalogLegalityAudit, self).as_dict()
