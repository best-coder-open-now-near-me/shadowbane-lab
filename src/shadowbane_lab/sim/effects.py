    ...
    def _apply_damage(
        ...
        *,
        ...
        resistance_floor = subject.scalars.get(
            f"resistance_floor.{damage_type}", subject.scalars.get("resistance_floor", -1.0)
        )
        ...
        after_absorbers, absorbed = self._consume_absorbers(
            item,
            subject,
            damage_type,
            after_resistance,
