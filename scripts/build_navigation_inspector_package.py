...
REQUIRED_VENDOR_TESTS = frozenset({
    ...
    "wonderbane_extension_vendor_navigation_native",
    "wonderbane_extension_vendor_navigation_channel",
...
def main() -> int:
    ...
    for profile in ("full", "diagnostics-only"):
        ...
        required_native_tests = {
            ...
            "wonderbane_extension_movement_lifetime_parent-continuity",
            "wonderbane_extension_movement_lifetime_door-normal",
            "wonderbane_extension_movement_lifetime_door-rollback",
            "wonderbane_extension_movement_lifetime_door-foreign",
            "wonderbane_extension_movement_lifetime_door-teardown",
            "wonderbane_extension_movement_lifetime_door-query",
            "wonderbane_extension_movement_lifetime_door-query-fault",
            "wonderbane_extension_movement_runtime_parent-keyboard",
            "wonderbane_extension_movement_runtime_parent-controller",
            "wonderbane_extension_movement_runtime_parent-controller-text",
            ...
            "wonderbane_extension_movement_native_ui",
            "wonderbane_extension_movement_runtime_parent-drag",
            "wonderbane_extension_movement_runtime_parent-automation",
            "wonderbane_extension_movement_runtime_parent-ui",
            "wonderbane_extension_movement_runtime_parent-focus",
            "wonderbane_extension_movement_runtime_parent-stop-failure",
            "wonderbane_extension_movement_runtime_parent-nested-stop",
            "wonderbane_extension_movement_runtime_parent-notice",
            "wonderbane_extension_movement_runtime_parent-identity",
            "wonderbane_extension_movement_runtime_parent-actor",
            "wonderbane_extension_movement_runtime_parent-unowned",
            "wonderbane_extension_movement_runtime_parent-disabled",
        ...
        try:
            run(
                ...
                [sys.executable, "-m", "pytest", "tests/test_native_movement_session.py",
                 ...
                 "tests/test_controller_profile.py",
                 "tests/test_native_movement_wire.py",
...
""", arguments.reviewed_client.resolve(),
    ...
    with tarfile.open(sdist) as package:
        ...
        for relative in (
            ...
            "native/wonderbane_extension/movement_action_profile.h",
            "src/shadowbane_lab/client_extension/controller_profile.py",
            "src/shadowbane_lab/client_extension/movement_wire.py",
            "tests/fixtures/native_movement_wire_v3.hex",
