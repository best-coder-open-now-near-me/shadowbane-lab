...
param(
    ...
    [string] $ExtensionVersion = "1.6.6",
    [string] $PackageDirectory = (
        "S:\Wonderbane-graphics-wb-55fbad5f-4b602995-cel-1.6.6"
    ),
...
$expectedExtensionSha256 = "b6aef0957140eeb384356f8d455954dd2b47224f2a2b4160011b4fe980d1b6c6"
