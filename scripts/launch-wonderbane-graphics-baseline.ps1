...
param(
    ...
    [string] $ExtensionVersion = "1.6.9",
    [string] $PackageDirectory = (
        "S:\Wonderbane-graphics-wb-55fbad5f-4b602995-cel-1.6.9"
    ),
...
$expectedExtensionSha256 = "51fa86429fa65f1a1bbef7d384acd455bd06fcbad9b264bca453d504f01d9327"
