...
param(
    ...
    [string] $ExtensionVersion = "1.4.8",
    [string] $PackageDirectory = (
        "S:\Wonderbane-graphics-wb-55fbad5f-4b602995-cel-1.4.8"
    )
)
...
$expectedExtensionSha256 = "205ea4c6781b95794879b5d075f3e4b52b3323e77752266dbf9479b34c5b5d05"
