...
param(
    ...
    [string] $ExtensionVersion = "1.6.5",
    [string] $PackageDirectory = (
        "S:\Wonderbane-graphics-wb-55fbad5f-4b602995-cel-1.6.5"
    ),
...
$expectedExtensionSha256 = "e397f9f661032253f1dc0a433f8f64bc62f6548e5c57873ecabc822f20b4d228"
