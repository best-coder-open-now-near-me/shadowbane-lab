...
param(
    ...
    [string] $ExtensionVersion = "1.4.7",
    [string] $PackageDirectory = (
        "S:\Wonderbane-graphics-wb-55fbad5f-4b602995-cel-1.4.7"
    )
)
...
$expectedExtensionSha256 = "665051a2018be84da2a543e6d9503066254985b38a9ee42cf15df393f5dcf60b"
