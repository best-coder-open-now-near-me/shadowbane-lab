...
param(
    ...
    [string] $ExtensionVersion = "1.5.2",
    [string] $PackageDirectory = (
        "S:\Wonderbane-graphics-wb-55fbad5f-4b602995-cel-1.5.2"
    )
)
...
$expectedExtensionSha256 = "1c20eaf97376fda8d40012e9cfec07f6a144e22494f210352fc33b77f47f2a30"
