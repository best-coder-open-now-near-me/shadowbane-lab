...
param(
    ...
    [string] $ExtensionVersion = "1.6.7",
    [string] $PackageDirectory = (
        "S:\Wonderbane-graphics-wb-55fbad5f-4b602995-cel-1.6.7"
    ),
...
$expectedExtensionSha256 = "96881f786ddb4c7915847983ddc1770c21decc491ffa77a2350562cbdd284b4c"
