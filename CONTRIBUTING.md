...
The combined candidate requires the cue's visible native-material gate and the
effects runtime suppression tests. Run required native tests with `ctest -C Release -LE
